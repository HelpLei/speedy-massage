...
function renyuan() {
		location.href ='../phry/user';
};
function jiating() {
		location.href ='../phry/family';
};
function xueli() {
		location.href ='../phry/education';
};
function gongzuo() {
		location.href ='../phry/workHistory';
};
function dangji() {
		location.href ='../phry/party';
};
function jiangcheng() {
	location.href ='../phry/rewards';
};
function kaohe() {
	location.href ='../phry/check';
};