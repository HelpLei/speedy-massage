...
function edit(id) {
    $.ajax({
        ...
        success : function(data) {
            if (data.code == 0) {
                var row = data.eductionDTO;

                $('#educationId').val(row.educationId);
                $("input[name='eduCategory'][value='"+row.eduCategory+"']").prop("checked",true);
                $('#educationCodeId').val(row.educationCodeId);
                $('#eduCode').val(row.eduCode);
                $('#eduName').val(row.eduName);
                $('#eduYear').val(row.eduYear);
                $('#degreeCode').val(row.degreeCode);

                $('#degreeName').val(row.degreeName);
                $('#schoolName').val(row.schoolName);
                $('#subjectCategory').val(row.subjectCategory);
                $('#subjectName').val(row.subjectName);
                $('#entranceTime').val(row.entranceTime);
                $('#graduationTime').val(row.graduationTime);
                $('#awardTime').val(row.awardTime);


                if(row.fileDO!=null){
                    $('#graduationFileId').val(row.graduationFileId);
                ...
                if(row.fileDO1!=null) {
                    $('#awardFileId').val(row.awardFileId);
                    $('#showImg1').attr("src",row.fileDO1.url);
                }else{
                    $('#awardFileId').val(0);
