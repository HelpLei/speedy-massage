...
var _typeof = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function (d) {
    ...
    function d(f, g) {
        for (var j,
                 h = 0; h < g.length; h++)j = g[h], j.enumerable = j.enumerable || !1, j.configurable = !0, 'value' in j && (j.writable = !0), Object.defineProperty(f, j.key, j)
    }
...
var Dialog = function () {
    ...
    var g = function () {
        ...
        return _createClass(h, [{
            key: 'extend', value: function extend(j, k) {
                for (var l in k)j[l] = k[l]
            }
        }, {
            key: 'init', value: function init(j, k) {
                k && 'object' === ('undefined' == typeof k ? 'undefined' : _typeof(k)) && this.extend(this.set, k);
                var m = document.createElement('div'), p = document.createElement('div'), q = this, r = q.set;
