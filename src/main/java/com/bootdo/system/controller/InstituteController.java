...
@Controller
@RequestMapping("/system/institute")
public class InstituteController extends BaseController {
	...
	public List<DeptDO> list() {
		...
		query.put("isDept", DeptSelect.机构.getCode());
	...
	public R save(DeptDO sysDept) {
		...
		sysDept.setIsDept(DeptSelect.机构.getCode());
	...
	public Tree<DeptDO> tree() {
		...
		tree = sysDeptService.getTree(DeptSelect.机构.getCode());
		return tree;
	}
